...
\usage{
GetoptLong(spec, help = TRUE, version = TRUE, envir = parent.frame(), export = FALSE, argv_str = NULL)
}
\arguments{
  ...
  \item{export}{whether export options as variables into user's enrivonment}
