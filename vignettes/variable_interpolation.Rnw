...
(In {\it Perl}, I always use recursive regular expression to extrace such pairing parentheses. But in {\it R}, it seems difficult.)
...
If varaibles are passed through list, {\tt qq} only looks up in the specified list.
