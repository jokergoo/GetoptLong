...
The options in the usage text can be grouped by setting separater lines.
The separater line should contain two elements: the separator and the description.
